...
-- AddForeignKey
ALTER TABLE "public"."AuthAccessTokens" ADD CONSTRAINT "AuthAccessTokens_tokenableUuid_fkey" FOREIGN KEY ("tokenableUuid") REFERENCES "public"."Admins"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
